...
<?php
    ...
    {
        if ($_POST["action"] ==0) // 0 ->on met les informations     
        {
        ...
        //on recup les info de telephone;
            while ($ligne_telephone = $reponse_telephone->fetch()) {
                echo "<table>";
                echo "<tr> <td > $ligne_telephone[0] </td> <td> <SELECT name='type' size='1'>";
                echo "<OPTION value='1' ";
                if ($ligne_telephone[1] =='PrF') {
                    echo "selected ";
                }
                echo ">fixe prof";
                echo "<OPTION value='2' ";
                if ($ligne_telephone[1] == 'PeF') {
                    echo "selected ";
                }
                echo ">fixe perso";
                echo "<OPTION value='3' ";
                if ($ligne_telephone[1] == 'PrM') {
                    echo "selected ";
                }
                echo ">mobile prof";
                echo "<OPTION value='4' ";
                if ($ligne_telephone[1] == 'PeM') {
                    echo "selected ";
                }
                echo ">mobile perso";
                echo "</SELECT></td></tr>";
